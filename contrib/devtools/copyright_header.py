...
# Copyright (c) 2018-2023 The Rupaya Core developers
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Rupaya Core developers'
...
UPDATE_USAGE = """
Updates all the copyright headers of "The Rupaya Core developers" which were
changed in a year more recent than is listed. For example:

// Copyright (c) <firstYear>-<lastYear> The Rupaya Core developers

will be updated to:

// Copyright (c) <firstYear>-<lastModifiedYear> The Rupaya Core developers

where <lastModifiedYear> is obtained from the 'git log' history.

This subcommand also handles copyright headers that have only a single year. In those cases:

// Copyright (c) <year> The Rupaya Core developers

will be updated to:

// Copyright (c) <year>-<lastModifiedYear> The Rupaya Core developers
...
Arguments:
    <base_directory> - The base directory of a Rupaya source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The Rupaya Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The Rupaya Core developers'
                 % (filename))
...
INSERT_USAGE = """
Inserts a copyright header for "The Rupaya Core developers" at the top of the
...
If the file already has a copyright for "The Rupaya Core developers", the
script will exit.
