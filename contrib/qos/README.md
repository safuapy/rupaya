...
This means one can have an always-on rupxd instance running, and another local rupxd/rupx-qt instance which connects to this node and receives blocks from it.
