...
#error Client version information missing: version is not defined by rupx-config.h or in any other way
#endif
...
/**
 * rupxd-res.rc includes this file, but it cannot cope with real c++ code.
