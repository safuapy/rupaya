...
#ifndef RUPX_QT_CREATEPROPOSALDIALOG_H
#define RUPX_QT_CREATEPROPOSALDIALOG_H
...
public:
    explicit CreateProposalDialog(RupxGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel);
...
#endif // RUPX_QT_CREATEPROPOSALDIALOG_H
