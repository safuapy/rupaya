...
/**
  Rupaya GUI main class. This class represents the main window of the Rupaya UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class RupxGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit RupxGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~RupxGUI();
