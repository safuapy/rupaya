...
#ifndef RUPX_QT_SENDCUSTOMFEEDIALOG_H
#define RUPX_QT_SENDCUSTOMFEEDIALOG_H
...
public:
    explicit SendCustomFeeDialog(RupxGUI* parent, WalletModel* model);
    ~SendCustomFeeDialog();
...
#endif // RUPX_QT_SENDCUSTOMFEEDIALOG_H
