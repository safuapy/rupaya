...
SettingsConsoleWidget::SettingsConsoleWidget(RupxGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    messageInternal(RPCExecutor::CMD_REPLY, (tr("Welcome to the Rupaya RPC console.") + "<br>" +
