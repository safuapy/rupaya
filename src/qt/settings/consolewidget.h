...
#ifndef RUPX_QT_SETTINGS_CONSOLEWIDGET_H
#define RUPX_QT_SETTINGS_CONSOLEWIDGET_H
...
public:
    explicit SettingsConsoleWidget(RupxGUI* _window, QWidget *parent = nullptr);
...
#endif // RUPX_QT_SETTINGS_CONSOLEWIDGET_H
