...
#ifndef RUPX_QT_SETTINGS_FAQWIDGET_H
#define RUPX_QT_SETTINGS_FAQWIDGET_H
...
public:
    ...
    explicit SettingsFaqWidget(RupxGUI* parent, MNModel* _model);
    ~SettingsFaqWidget();
...
#endif // RUPX_QT_SETTINGS_FAQWIDGET_H
