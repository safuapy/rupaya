...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("rupx"), "Rupx");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://rupaya.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/rupx"));
    BOOST_CHECK(validateURL("https://foo.bar/rupaya/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.rupaya.com"));
