...
class FullBlockTest(RupxTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure rupxd isn't accepting b26
        ...
        # Extend the b28 chain to make sure rupxd isn't accepting b28
        ...
        # Rupaya: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the Rupaya code has custom code which does so);
