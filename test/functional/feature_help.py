...
"""Verify that starting rupxd with -h works as expected."""
...
class HelpTest(RupxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start rupxd with -? for help text")
        ...
        self.log.info("Start rupxd with -version for version information")
