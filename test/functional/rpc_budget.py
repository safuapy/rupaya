...
class BudgetProposalTest(RupxTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid Rupaya address")
        assert_raises_rpc_error(-5, "Invalid Rupaya address", self.nodes[0].preparebudget,
